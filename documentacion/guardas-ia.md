...
| **Decir "listo" sin verificar** | Se declara terminado sin correrlo | Terminado = `npm run revisar` + prueba en el navegador + decir qué no se verificó | `convenciones.md` |
...
| **Mezclar idiomas** | Identificadores en inglés y textos en español, sin criterio | Todo en español, sin tildes ni ñ en identificadores | `convenciones.md` |
