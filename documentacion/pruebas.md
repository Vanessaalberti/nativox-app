...
**Reglas:** una prueba que falla se arregla en el código, no en lo esperado (salvo que el comportamiento esperado haya cambiado, y se explica en el PR). La cobertura no es una meta: una prueba tiene que poder fallar si el comportamiento está mal.
