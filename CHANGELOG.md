...
- Módulo `evaluar-equipo`: detecta WebGPU, f16 y la placa, mide una pasada de Whisper y la traducción, y recomienda versión de Whisper, nivel de velocidad (barra de 4 niveles) y si conviene la nube; con pruebas de las reglas.
