/* eslint-disable */
// Generated by Wrangler by running `wrangler types servidor/plataforma/env.d.ts` (hash: 6ba44658263c1236ed97448f0ce783d0)
// Runtime types generated with workerd@1.20260921.1 2026-09-24 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	SALA: DurableObjectNamespace<import("../entrada/index").Sala>;
	PRODUCCION: DurableObjectNamespace<import("../entrada/index").Produccion>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../entrada/index");
		durableNamespaces: "Sala" | "Produccion";
	}
